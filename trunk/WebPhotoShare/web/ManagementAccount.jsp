                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        %>
                                                        <a href="EditAccount.jsp?accid=<%out.print(s.getAccountId());%>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
                                                            <%                                                                    }
                                                            %>
                                                    </td>
                                                    <td>
                                                        ...
                                                        %>
                                                        <a onClick="if(confirm('Are you sure?')) {window.location='AdminDelete?accid=<%out.print(s.getAccountId());%>';}"><img src="images/trash.png" alt="" title="" border="0" /></a></td>
                                                            <%                                                                    }
                                                            %>
                                                    </td>             
                                                </tr>
